...
def get_parameters():
    ...
    parser.add_argument('--model', type=str, default='model', choices=['model', 'qgan'])
    ...
    parser.add_argument('--version', type=str, default='Agan_1')
    ...
    parser.add_argument('--dataset', type=str, default='cifar', choices=['celeb'])
